...
{ 
  ...
  this->rc_in.PITCH = manualMap2(this->rc_in.PITCH, this->rc_in.PITCH_MIN, this->rc_in.PITCH_MID, this->rc_in.PITCH_MAX, MIN_PWM_IN, (MAX_PWM_IN+MIN_PWM_IN)/2, MAX_PWM_IN);
